$(document).ready(function () {
    ...
    $("#contact-form").submit(function (event) {
        emailjs.init("yTO8Ma_yBEU93QwHx");

        emailjs.sendForm('service_cmd86pt', 'template_m5ic699', '#contact-form')
...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Portfolio | Ankit Sahu";
...
var typed = new Typed(".typing-text", {
    strings: ["Cyber Security Engineer", "Ethical Hacker", "Vulnerability Tester", "Pentration Tester", "Web Developer"],
    loop: true,
    typeSpeed: 50,
    backSpeed: 25,
    backDelay: 500,
...
function getExperience() {
    return fetch("./experience/experience.json")
